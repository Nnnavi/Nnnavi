...
describe('StringBuilder', function () {
    ...
    describe('constructor', function () {
        it('wiшh empty constructor', function () {
            let result = sb.toString();

            assert.equal(result, '', `Must return empty string, but return ${result}`);
        });
        ...
        it('with different type from string', function () {
            let text = [];
    ...
    describe('append', function () {
        ...
        it('with multiple calls', function () {
            let text = 'Text';
            let testText = 'TEST';
    ...
    describe('insertAt', function () {
        it('with correct param char', function () {
            let text = 'Text';
            sb.append(text);
        ...
        it('with correct param string', function () {
            let text = 'Text';
            sb.append(text);
        ...
        // it('with different type from number', function () {
        //     let text = 'Text';
        //     let index = '1';
    ...
    describe('complex', function () {
        it('with all methods call', function () {
